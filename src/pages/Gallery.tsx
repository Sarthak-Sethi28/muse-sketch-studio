...
const DESIGNS = [
  ...
  },
  {
    ...
    imageSet: 4,
    title: "Brise d'Été",
    category: "Resort Couture",
    season: "SS 2026",
    desc: "A romantic flowing summer gown with cascading chiffon layers and a delicate waist bow. Effortless femininity in warm coral tones.",
    col: "#F9A8D4",
    dark: "#BE185D",
    tags: ["Summer Gown", "Chiffon", "Romantic"],
  },
  {
    id: 5,
    imageSet: 5,
    title: "Le Smoking Vert",
    category: "Ready-to-Wear",
    season: "AW 2025",
    desc: "A forest-green power suit with razor-sharp lapels, structured shoulders, and wide-leg trousers. Modern authority in botanical tones.",
    col: "#6EE7B7",
    dark: "#047857",
    tags: ["Power Suit", "Tailored", "Wide-Leg"],
  },
  {
    id: 6,
    imageSet: 6,
    title: "Minuit Asymétrique",
    category: "Haute Couture",
    season: "AW 2025",
    desc: "A midnight blue asymmetric gown with a dramatic hi-lo hem, gold star embellishments, and a single long glove for theatrical elegance.",
    col: "#818CF8",
    dark: "#3730A3",
    tags: ["Asymmetric", "Evening Gown", "Embellished"],
  },
  {
    id: 7,
    imageSet: 1,
    ...
    category: "Haute Couture",
    season: "SS 2026",
    desc: "A sculptural silk column dress with draped cowl neckline and side slit. Timeless elegance in ivory and champagne.",
    col: "#FCD34D",
    dark: "#D97706",
    tags: ["Column Dress", "Silk", "Evening"],
  },
  {
    id: 8,
    imageSet: 2,
    ...
    category: "Ready-to-Wear",
    season: "AW 2025",
    desc: "Sharp architectural tailoring — double-breasted coat with sculptural shoulders, high-waisted wide trousers. Modern minimalism in charcoal.",
    col: "#94A3B8",
    dark: "#475569",
    tags: ["Architectural", "Tailoring", "Minimalist"],
  },
  {
    id: 9,
    imageSet: 3,
    title: "Flamme Nocturne",
    category: "Avant-Garde",
    season: "AW 2025",
    desc: "Dramatic floor-length coat with flame-like asymmetric panels, metallic thread embroidery, and a sculptural funnel collar.",
    col: "#F87171",
    dark: "#B91C1C",
    tags: ["Statement Coat", "Metallic", "Dramatic"],
  },
  {
    id: 10,
    imageSet: 4,
    title: "Vagues d'Opale",
    category: "Resort Couture",
    season: "SS 2026",
    desc: "Fluid maxi dress with layered organza ruffles and a plunging V-neck. Soft opalescent tones for sunset soirées.",
    col: "#A78BFA",
    dark: "#6D28D9",
    tags: ["Maxi Dress", "Organza", "Resort"],
  },
  {
    id: 11,
    imageSet: 5,
    title: "Le Tuxedo Rose",
    category: "Ready-to-Wear",
    season: "SS 2026",
    desc: "A blush pink tuxedo with satin lapels, cropped wide-leg trousers, and a silk bow. Soft power dressing for spring.",
    col: "#FDA4AF",
    dark: "#E11D48",
    tags: ["Tuxedo", "Blush Pink", "Spring"],
  },
  {
    id: 12,
    imageSet: 6,
    ...
    category: "Haute Couture",
    season: "AW 2025",
    desc: "An iridescent gown with northern lights-inspired ombré — deep teal to violet — and a sweeping train with crystal beading.",
    col: "#67E8F9",
    dark: "#0891B2",
    tags: ["Iridescent", "Ombré", "Crystal"],
  },
];
